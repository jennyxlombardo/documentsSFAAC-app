...
export default function NavBar() {
    return (
      <div className="flex flex-col p-10 md:p-0 md:flex-row md:justify-around justify-between items-center h-36 text-xl sticky w-screen md:border-nBlue md:border-b">
        <button className="p-2 hidden md:block">Home</button>
        <button className="p-2 hidden md:block">Services</button>
        ...
        <button className="p-2">About</button>
            ...
            <button className="p-2 md:hidden block">Home</button>
        <button className="p-2 md:hidden block">Services</button>
      </div>
    );
}