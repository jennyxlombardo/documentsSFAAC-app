  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-around">
        <p className="md:absolute md:flex md:flex-col md:justify-center text-center md:top-44 md:m-20 md:p-10 md:rounded md:bg-nBlue/80  md:w-1/2 md:min-h-96 md:h-auto md:flex md:items-center md:text-xl md:text-white  text-nBlue">
         At
